...
import pickle
import sys
sys.path.append("./Downloads/deepface-master/deepface")
sys.path.append("./Downloads/deepface-master/deepface/extendedmodels")
sys.path.append("./Downloads/deepface-master/deepface/commons")
from deepface.basemodels import VGGFace, OpenFace, Facenet, Facenet512, FbDeepFace, DeepID, DlibWrapper, ArcFace, SFaceWrapper, Boosting
...
def verify(e, e1, model_name = 'VGG-Face', distance_metric = 'cosine', model = None, enforce_detection = True, detector_backend = 'opencv', align = True, prog_bar = True, normalization = 'base'):
	...
	for i in  model_names:
		...
		# 		, normalization = normalization
		# 		)
		img1_representation = e
		img2_representation = e1
		#----------------------
...
def representAll(db_path,des_path='',model_name = 'VGG-Face', model = None, enforce_detection = True, detector_backend = 'opencv', align = True, normalization = 'base',prog_bar = True, silent=False,distance_metric = 'cosine'):
# distance_metric = 'cosine',  prog_bar = True, silent=False)
	# tic = time.time()
	if os.path.isdir(db_path) == True:
		...
		# file_name = "representations_%s.txt" % (model_name)
		...
		if(True): #create representation.pkl from scratch
			employees = []
...
def find(img_representation, representations, model_name ='VGG-Face', distance_metric = 'cosine', model = None, enforce_detection = True, detector_backend = 'opencv', align = True, prog_bar = True, normalization = 'base', silent=False):
	...
	"""
	tic = time.time()
	# representations = representAll(db_path=db_path,model_name=model_name,distance_metric=distance_metric,detector_backend=detector_backend)
...
# ___________________________________________________________________________
	...
	for j in model_names:
		...
		# 	, normalization = normalization
		# 	)
		target_representation = img_representation
